...
Na visão do Reino do Norte, o terreno 2D navegável usa o master 6 × 6 aprovado, detalhado em 36 regiões sobrepostas e reunido numa composição de 5760 × 5760 px. A área virtual mede 15000 × 15000 unidades. A visão de 100% mantém o mapa próximo, agora 15% mais afastado, e permite navegar até as quatro bordas reais; o zoom máximo é 130%. Nuvens branco/cinza mais visíveis e rápidas acompanham a geografia durante a navegação. A névoa opaca cobre o exterior e se dissolve em formas móveis e irregulares dentro de uma faixa projetada máxima de 96 px, sem linha aparente no fim da imagem. Grupos de pinheiros e carvalhos usam o atlas existente sobre as áreas de mata marcadas pelo usuário; construções e cidades clicáveis continuam temporariamente ocultas. Seus seis locais e missões continuam no SQL; o botão Missões do reino e o mural seguem disponíveis. O mapa mundi 3D permanece independente. Consulte [a documentação da visão do reino](docs/KINGDOM-2D.md) e [a procedência da arte](docs/KINGDOM-ART.md). As estruturas preservadas serão retomadas na etapa seguinte.

O botão **Editar mapa** permite posicionar os objetos já ilustrados, ajustar tamanho e orientação e salvar um rascunho particular no PostgreSQL. O rascunho é recuperado ao voltar ao reino; depois de concluído, pode ser incorporado à composição compartilhada.
...
- Reino do Norte abre uma visão regional 2D inclinada: terreno amplo e sem repetição, com trilhas, pontes, nuvens suaves e névoa móvel somente nas bordas. Arraste/zoom e giro de 45° permitem explorar a área. Na etapa atual, os objetos e alvos de cidades foram retirados para aprovação do terreno; voltam na fase de estruturas. O Mundo em 3D permanece independente. Detalhes em [KINGDOM-2D.md](docs/KINGDOM-2D.md).
