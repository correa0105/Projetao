...
Na visão do Reino do Norte, um solo original de grama e terra, visto de cima, substitui a pintura 6 × 6. O chão não contém estradas, rios, árvores, construções ou outros objetos desenhados; sua textura continua coerente quando o mapa gira. A área navegável permanece em 15000 × 15000 unidades, com giro em oito direções e zoom de 100–130%. A cena comum começa vazia, enquanto o editor permite montar uma nova composição privada. Os seis locais e suas missões continuam no SQL; o botão Missões do reino e o mural seguem disponíveis. O Mundo 3D permanece independente. Consulte [a documentação da visão do reino](docs/KINGDOM-2D.md).
